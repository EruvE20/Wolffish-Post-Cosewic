...
```{r, fig.cap="Stratified biomass of Atlantic wolffish in the 4VsW RV Survey, 1986-2010, with three-year running mean (blue).", fig.align='center'}
...
```{r, fig.cap="Weighted area occupied of Atlantic wolffish in the 4VsW RV Survey, 1986-2010, with three-year running mean (blue).", fig.align='center'}
ggplot(total, aes(x=YEAR, y=area_occupied))+
  geom_point()+
  geom_line(alpha=0.3)+
  # geom_smooth(method = "loess", se = F)+
  ...
  geom_line(aes(y=rollmean(area_occupied, 3, na.pad = T)),
            col="blue")+
  theme_classic()+
  labs(x = "Year", y = "Stratified Area Occupied")
```
  
```{r, fig.cap="Stratified abundance of immature (<53 cm) and mature (>53 cm) Atlantic wolffish in the 4VsW RV Survey, 1986-2010, with three-year running means.", fig.align='center'}
...
ggplot(total, aes(x=YEAR, y=abundance, shape=maturity))+
  ...
  geom_line(alpha=0.3)+
  # geom_smooth(method = "loess", se = F)+
  geom_point(data=totalm, aes(y=rollmean(abundance, 3, na.pad = T)),
             size=2, color="#00D712")+
  geom_line(data=totalm, aes(y=rollmean(abundance, 3, na.pad = T)),
            color = "#00D712", size=1)+
    geom_point(data=totali, aes(y=rollmean(abundance, 3, na.pad = T)),
             size=2, color="blue")+
  geom_line(data=totali, aes(y=rollmean(abundance, 3, na.pad = T)),
            color = "blue", size=1)+
  theme_classic()+
...
```{r, fig.cap="Weighted area occupied of Atlantic wolffish in the 4X RV Survey, 2012-2020, with two-year running means.", fig.align='center'}
ggplot(total, aes(x=YEAR, y=area_occupied))+
  geom_point()+
  geom_line(alpha=0.3)+
  # geom_smooth(method = "loess", se = F)+
  geom_point(aes(y=rollmean(area_occupied, 2, na.pad = T)),
             col="blue", size=2)+
  geom_line(aes(y=rollmean(area_occupied, 2, na.pad = T)),
            col="blue")+
  theme_classic()+
  labs(x = "Year", y = "Stratified Area Occupied")
```
...
```{r, fig.cap="Stratified biomass of Atlantic wolffish in the Summer RV Survey, 1970-2021, with three-year running mean (blue).", fig.align='center'}
strat <- summer_null %>% 
  filter(STRAT %in%(440:495)) %>% 
  group_by(YEAR, STRAT) %>% 
  summarize(numsets = length(unique(SETNO)))
...
```{r, fig.cap="Weighted area occupied of Atlantic wolffish in the Summer RV Survey, 1970-2021, with three-year running mean (blue).", fig.align='center'}
ggplot(total, aes(x=YEAR, y=area_occupied))+
  geom_point()+
  geom_line(alpha=0.3)+
  # geom_smooth(method = "loess", se = F)+
...
```{r, fig.cap="Stratified abundance of immature (<53 cm) and mature (>53 cm) Atlantic wolffish in the Summer RV Survey, 1970-2021, with three-year running means.", fig.align='center'}
abun <- summer_lengths %>% 
  mutate(maturity = ifelse(FLEN > 53, "mature", "immature")) %>% 
  mutate(standard_dist = DIST/1.75) %>% 
  group_by(YEAR, STRAT, maturity) %>% 
...
```{r, fig.cap="Stratified biomass of Atlantic wolffish in the Georges Bank RV Survey, 1987-2021, with three-year running mean (blue).", fig.align='center'}
strat <- georges_null %>% 
  group_by(YEAR, STRAT) %>% 
  summarize(numsets = length(unique(SETNO)))
...
```{r, fig.cap="Weighted area occupied of Atlantic wolffish in the Georges Bank RV Survey, 1987-2021, with three-year running mean (blue).", fig.align='center'}
ggplot(total, aes(x=YEAR, y=area_occupied))+
  geom_point()+
  geom_line(alpha=0.3)+
  # geom_smooth(method = "loess", se = F)+
...
```{r, fig.cap="Stratified abundance of immature (<53 cm) and mature (>53 cm) Atlantic wolffish in the Georges Bank RV Survey, 1987-2021, with three-year running means.", fig.align='center'}
...
i <- ggplot(total, aes (YEAR, log(abundance))) +
  ...
  geom_smooth(method = 'lm', se = FALSE, color = 'black') +
  theme_classic() +
  labs(x="Year", y="Log (count)", title="Georges total")
...
```{r, fig.cap="Catch per Unit Effort of Atlantic wolffish in the Snowcrab Fixed Survey", fig.align='center'}
cpue <- isdb %>% 
...
ggplot(cpue, aes(YEAR, CPUE))+
  ...
  geom_line()+
  theme_classic()+
  labs(title = "Snowcrab Survey CPUE",
       x = 'Year',
       y = 'Mean Catch (kg) per tow')
```
...
ggplot(cpue, aes(YEAR, CPUE))+
  ...
  geom_line()+
  theme_classic()+
  labs(title = "4 VsW Sentinel Longline Survey CPUE",
       x = 'Year',
...
ggplot(cpue, aes(YEAR, CPUE))+
  ...
  labs(title = "ITQ/Lobster Surveys Catch per tow",
       x = 'Year',
       y = 'Mean Catch (kg) per tow')
```
  
```{r, fig.cap=" Total weight of Atlantic wolffish landings for Industry and Commerical Surveys", fig.align='center' }
